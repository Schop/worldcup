        ...
        <div class="content-box-large">
          ...
          <!-- first name -->
            ...
            <?php  } ?>
              ...
              <div class='col-sm-8'>
                <input type="text" name="first_name" value="<?php echo set_value('first_name',$user->first_name); ?>" placeholder="<?php echo lang('first_name');?>" class="form-control">
          ...
          <!-- last name -->
            ...
            <?php  } ?>
              ...
              <div class="col-sm-8">
                <input type="text" name="last_name" value="<?php echo set_value('last_name', $user->last_name); ?>" class="form-control" placeholder="<?php echo lang('last_name');?>">
          ...
          <!-- username -->
            ...
            <?php  } ?>
              ...
              <div class="col-sm-8">
                <input type="text" name="username" value="<?php echo set_value('username', $user->username); ?>" class="form-control" placeholder="<?php echo lang('username');?>">
          ...
          <!-- email -->
            ...
            <?php  } ?>
              ...
              <div class="col-sm-8">
                <input type="email" name="email" value="<?php echo set_value('email', $user->email); ?>" class="form-control" placeholder="<?php echo lang('email');?>">
            ...
            <?php } ?>
              ...
              { ?>
                ...
                ?>    
                  <div class="checkbox">
                    <label>
                    <input type="checkbox" name="groups[]" value="<?php echo $group->id; ?>" <?php echo set_checkbox('groups[]', $group->id, in_array($group->id,$usergroups)); ?> >
                      <?php echo ' '.$group->name; ?>
                    </label>
                  </div>
                <?php
