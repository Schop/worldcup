        ...
        <div class="content-box-large">
          ...
          <?php echo form_open('',array('class'=>'form-horizontal'));?>
            <div class="form-group <?php if(form_error('match_number')) { echo 'has-error'; }?>">
              ...
              <div class='col-sm-8'>
                <input type="text" name="match_number" value="<?php echo set_value('match_number'); ?>" class="form-control" placeholder="<?php echo lang('match_number'); ?>">
            ...
            <div class="form-group <?php if(form_error('hometeam_id')) { echo 'has-error'; }?>">
              ...
              <div class='col-sm-8'>
                <?php echo form_dropdown('hometeam_id', $teams,  set_value('hometeam_id'),"class='form-control'"); ?>
            ...
            <div class="form-group <?php if(form_error('awayteam_id')) { echo 'has-error'; }?>">
              ...
              <div class='col-sm-8'>
                <?php echo form_dropdown('awayteam_id', $teams, set_value('awayteam_id'),"class='form-control'"); ?>
            ...
            <div class="form-group <?php if(form_error('matchtype_id')) { echo 'has-error'; }?>">
              ...
              <div class='col-sm-8'>
                <?php echo form_dropdown('matchtype_id', $matchtypes, set_value('matchtype_id'),"class='form-control'"); ?>
            ...
            <div class="form-group <?php if(form_error('venue_id')) { echo 'has-error'; }?>">
              ...
              <div class='col-sm-8'>
                <?php echo form_dropdown('venue_id', $venues, set_value('venue_id'),"class='form-control'"); ?>
            ...
            <div class="form-group <?php if(form_error('match_time')) { echo 'has-error'; }?>">           
              ...
              <div class='col-sm-8'>
                <input type="text" name="match_time" class="form-control" timepicker"" value="<?php echo set_value('match_time'); ?>" placeholder="yyyy-mm-dd HH:ii">
