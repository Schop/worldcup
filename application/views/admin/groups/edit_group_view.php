        ...
        <div class="content-box-large">
          ...
          <?php echo form_open('',array('class'=>'form-horizontal'));?>
            ...
            <?php  } ?>
              ...
              <div class='col-sm-8'>
                <input type="text" name="group_name" value="<?php echo set_value('group_name',$group->name); ?>" class="form-control">
            ...
            <?php  } ?>
              ...
              <div class="col-sm-8">
                <input type="text" name="group_description" value="<?php echo set_value('group_description',$group->description); ?>" class="form-control">
            ...
            <div class="col-sm-offset-4 col-sm-8">
              <button type="submit" name="submit" value="Save" class="btn btn-success btn-outline"><span class="glyphicon glyphicon-save"></span> <?php echo lang('save');?></button>
          ...
          <div class="panel-heading">
            ...
            <div class="panel-body">
              ...
              <table class="table dataTable" cellspacing="0" width="100%">
                <thead>
                  <tr><td><?php echo lang('ID');?></td><td><?php echo lang('group_name');?></td><td><?php echo lang('group_description');?></td></tr>
                </thead>
                <tbody>
