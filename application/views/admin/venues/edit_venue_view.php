        ...
        <div class="content-box-large">
          ...
          <?php echo form_open('',array('class'=>'form-horizontal'));?>
            ...
            <?php  } ?>
              ...
              <div class='col-sm-8'>
                <input type="text" name="venue_name" value="<?php echo set_value('venue_name', $venue->name); ?>" class="form-control" placeholder="<?php echo lang('venue_name'); ?>">
            ...
            <?php  } ?>
              ...
              <div class='col-sm-8'>
                <input type="text" name="venue_location" value="<?php echo set_value('venue_location', $venue->location); ?>" class="form-control" placeholder="<?php echo lang('venue_location'); ?>">
            ...
            <?php  } ?>
              ...
              <div class="col-sm-8">
                <input type="text" name="venue_time_offset_utc" value="<?php echo set_value('venue_time_offset_utc', $venue->time_offset_utc); ?>" class="form-control" placeholder="<?php echo lang('venue_time_offset_utc'); ?>">
            ...
            <?php echo form_hidden('venue_id',$venue->id); ?>
          <?php echo form_close();?>          
          </div>        
        </div>
      </div>
